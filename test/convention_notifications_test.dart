...
void main() {
  final ConventionNotificationsPlatform initialPlatform = ConventionNotificationsPlatform.instance;

  test('$MethodChannelConventionNotifications is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelConventionNotifications>());
  });

  test('getPlatformVersion', () async {
    ConventionNotifications conventionNotificationsPlugin = ConventionNotifications();
    MockConventionNotificationsPlatform fakePlatform = MockConventionNotificationsPlatform();
